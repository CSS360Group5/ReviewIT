 ...
 *
 * Revision: For testing purposes, the names of the output files
 * have been altered and the refreshInstance() method has been added.
 * 
...
public class TestRSystem {
	 ...
	 * @author Dimitar Kumanov
	 */
	public static TestRSystem getInstance(){
		if(myInstance == null){
			myInstance = new TestRSystem();
		}
		return myInstance;
	}
	...
	public void deserializeData() {
		...
		if((new File("./UserMap.ser")).exists() && (new File("./ConferenceMap.ser")).exists()){
			try {
				FileInputStream fisUser = new FileInputStream("./TestUserMap.ser");
				ObjectInputStream oisUser = new ObjectInputStream(fisUser);
				FileInputStream fisCon = new FileInputStream("./TestConferenceMap.ser");
...
//			System.out.print("Deserialization successful.");
	...
	public void serializeModel() {
		 ...
		 */
		try {
			FileOutputStream fosUser = new FileOutputStream("./TestUserMap.ser");
			ObjectOutputStream oosUser = new ObjectOutputStream(fosUser);
			FileOutputStream fosCon = new FileOutputStream("./TestConferenceMap.ser");
...
//		System.out.print("Serialization successful.");
	...
	/**
	 * Resets this TestRSystem instance.
	 * @author Kevin Ravana
	 */
